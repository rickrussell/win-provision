...
$tweaks = @(
	...
	"InstallDifferentialCompression", # "UninstallDifferentialCompression",
...
Function UninstallDifferentialCompression {
	Write-Output "Uninstalling Remote differential compression..."
	Disable-WindowsOptionalFeature -Online -FeatureName "MSRDC-Infrastructure" -NoRestart -WarningAction SilentlyContinue | Out-Null
}

# You need remote differential compression if you intend to pull from network shares
Function InstallDifferentialCompression {
	Write-Output "Installing Remote differential compression..."
	Enable-WindowsOptionalFeature -Online -FeatureName "MSRDC-Infrastructure" -NoRestart -WarningAction SilentlyContinue | Out-Null
}
